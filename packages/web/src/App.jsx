...
function MainContent({ 
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-gray-950">
      ...
      <div>
        <TopBar {...props} runs={Object.keys(lineageTreesIndex || {})} steps={lineageTreesIndex ? lineageTreesIndex[props.selectedRun]?.length || 0 : 0} />
      </div>
...
function MainApp() {
  ...
  useEffect(() => {
    ...
    fetch(`${LINEAGE_SOUNDS_BUCKET_HOST}/lineage-trees-metadata/evolution-runs-overview.json`)
      ...
      .catch(error => {
        setSoundSourceError('The chosen sound source cannot be reached. Please check your settings or choose another source.');
